...
function theme.get(user_opts)
  ...
  LspDiagnosticsHint = { link = "DiagnosticHint" },
    ...
    LspSignatureActiveParameter = { fg = colors.orange, bg = colors.fg_alt, italic = user_opts.italic, bold = user_opts.bold },
  ...
  BufferLineTabSeparatorSelected = { link = "BufferLineSeparator" },
    ...
    BufferLineErrorSelected = { bg = colors.ui.bufferline.tab_bg, fg = colors.red, italic = true, bold = true, sp = colors.darkred },
